...
import Evizinhotest2.model.UniversidadeUser;
...
public class UserController {
	...
	public String register(Model model, RedirectAttributes redirectAttributes) {
		try {
			AbstractUser user = new UniversidadeUser();
			model.addAttribute("user", user);
		}catch (Exception e) {
	...
	public String register(UniversidadeUser user, RedirectAttributes redirectAttributes) {
		try {
